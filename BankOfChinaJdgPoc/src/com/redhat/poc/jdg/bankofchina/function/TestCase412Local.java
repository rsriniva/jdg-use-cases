...
public class TestCase412Local {
    ...
    public TestCase412Local(boolean useXmlConfig, String cacheName) {
        TestCase412Local.useXmlConfig = useXmlConfig;
        TestCase412Local.cacheName = cacheName;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new TestCase412Local(useXmlConfig, cacheName).run();
    }
