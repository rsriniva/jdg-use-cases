...
public class TestCase411Local {
    ...
    public TestCase411Local(boolean useXmlConfig, String cacheName) {
        TestCase411Local.useXmlConfig = useXmlConfig;
        TestCase411Local.cacheName = cacheName;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new TestCase411Local(useXmlConfig, cacheName).run();
    }
