 ...
 * @author maping
 */
public class TestCase413RemoteMultiThreads extends Thread {
    ...
    public TestCase413RemoteMultiThreads(int fileName) {
    ...
    private static void LoadUserBaseInfo(BasicCache cache, int fileNumber) {
        try {
            ...
            Logger.getLogger(TestCase413RemoteMultiThreads.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
